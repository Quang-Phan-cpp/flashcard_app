...
class FlashcardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flashcard" do
    assert_difference("Flashcard.count") do
      post flashcards_url, params: { flashcard: { example: @flashcard.example, level: @flashcard.level, meaning: @flashcard.meaning, word: @flashcard.word } }
    end
  ...
  test "should update flashcard" do
    patch flashcard_url(@flashcard), params: { flashcard: { example: @flashcard.example, level: @flashcard.level, meaning: @flashcard.meaning, word: @flashcard.word } }
